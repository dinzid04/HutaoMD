...
exports.smsg = async (conn, m, store) => {
  ...
  try {
    ...
    m.body = m.message.conversation || (m.m && m.m.caption) || (m.m && m.m.text) || (m.xtype == "listResponseMessage" && m.m && m.m.singleSelectReply.selectedRowId) || (m.xtype == "buttonsResponseMessage" && m.m && m.m.selectedButtonId) || (m.xtype == "viewOnceMessage" && m.m && m.m.caption) || m.text || ''
  }
